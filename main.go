...
const PLUGIN_VERSION_RC = "alpha3"
const PLUGIN_LICENSE_YEAR = 2023

func main() {
	comms.HandleCommonFlags(plugin.Name, copyrightMessage(), PLUGIN_VERSION_MAJOR, PLUGIN_VERSION_MINOR,
		PLUGIN_VERSION_PATCH, PLUGIN_VERSION_RC)
